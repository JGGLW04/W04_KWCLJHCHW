...
namespace MoreMountains.CorgiEngine
{
	...
	/// </summary>
	[AddComponentMenu("Viking/Character/Abilities/Advanced Wizard Grab, Carry and Throw")]
	public class VikingAdvancedGrabCarryAndThrow : CharacterAbility
	{
		...
		protected VikingGlide _vikingGlide;
		...
		{
			base.Initialization();
			_vikingGlide = _character?.FindAbility<VikingGlide>();
			if (CarryParent == null)
			{
