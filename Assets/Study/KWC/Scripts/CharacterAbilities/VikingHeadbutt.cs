...
{	
	...
	/// </summary>
	[AddComponentMenu("Viking/Character/Abilities/Erik Headbutt")] 
	public class VikingHeadbutt : CharacterAbility
	{		
		...
		{
			// isMaxSpeed가 아닐 시 dash 불가
			if (_controller._isMaxSpeed == false)
			{
				return false;
			}
