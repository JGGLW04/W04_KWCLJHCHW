...
namespace MoreMountains.CorgiEngine
{
	...
	/// </summary>
	[AddComponentMenu("Viking/Weapons/Headbutt Weapon")]
	public class VikingHeadbuttWeapon : Weapon 
	{
		...
		protected VikingHeadbutt _vikingHeadbutt;
		...
		public override void Initialization()
		{
			...
			_vikingHeadbutt = Owner.GetComponent<VikingHeadbutt>();
		}
