...
/// </summary>
[AddComponentMenu("Viking/Managers/Custom Level Manager")]
public class CustomLevelManager : MMSingleton<CustomLevelManager>, MMEventListener<CorgiEngineEvent>
{
	...
	public virtual void Start()
	{
		...
		// TODO: 초기 설정 메서드들 호출
		CustomGUIManager.Instance.SetAvartarFocus(0);
		// 초기 인벤토리 대상 설정
