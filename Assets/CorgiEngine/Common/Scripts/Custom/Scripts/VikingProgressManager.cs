...
{	
	...
	/// </summary>
	public class VikingProgressManager : MMSingleton<VikingProgressManager>, MMEventListener<CorgiEngineEvent>
	{
		...
		protected const string _saveFolderName = "VikingProgress";
		...
		{
			MMSaveLoadManager.DeleteSaveFolder ("VikingProgress");			
		}
