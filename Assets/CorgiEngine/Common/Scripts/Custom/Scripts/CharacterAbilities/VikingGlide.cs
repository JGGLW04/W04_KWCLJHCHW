...
namespace MoreMountains.CorgiEngine
{
	...
	/// </summary>
	[AddComponentMenu("Viking/Character/Abilities/Wizard Glide")]
	public class VikingGlide : CharacterAbility
	{
		...
		// 조작키를 사용하지 않음, Grab 중 캐릭터가 낙하 상태일 때 발동
		/*/// <summary>
		...
		public virtual void GlideStart()
		{
			...
			Debug.Log("BeforeCS : " + _movement.CurrentState);
			...
			Debug.Log("AfterCS : " + _movement.CurrentState);
		}
